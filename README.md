...
| Periodicidade × dado | Intervalo mediano observado versus periodicidade declarada. É a verificação que teria pego o erro acima no primeiro segundo |
...
│   ├── 007_bi_reader.sql              usuário somente leitura para BI
